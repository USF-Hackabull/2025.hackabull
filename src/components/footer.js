    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <Title className="text-2xl mb-4">Contact Us</Title>
            <p className="text-gray-300 mb-4">
              Have questions? Reach out to us at{" "}
              <a
                href="mailto:contact@hackabull.com"
                className="text-green-400 hover:text-green-300 transition-colors"
              >
                contact@hackabull.com
              </a>
            </p>
          ...
          <div>
            <Title className="text-2xl mb-4">Quick Links</Title>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} HackaBull. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
