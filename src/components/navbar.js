...
const ApplyButton = ({ isMobile }) => {
  return (
    <a href="https://lu.ma/9e1x29r4" target="_blank" rel="noopener noreferrer">
      <button
        className={`text-white mx-auto bg-[#C1413E] pl-8 pr-8 pt-1 pb-1 rounded-xl font-bold ${
          isMobile
            ? "flex "
...
const NavLinks = ({ isMobile }) => {
  const links = [
    ...
    { 
      ...
      icon: (
        <svg
          className="w-8 h-8 text-[#395C6B] hover:text-white filter hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]"
          fill="currentColor"
          viewBox="0 0 24 24"
      ...
      <div className="md:hidden">
        {isOpen ? (
          <div className="flex-col">
            ...
            {/* Direct social media icons as fallback */}
            <div className="flex items-center space-x-4 ml-2">
              <a
                href="https://discord.gg/37jQnArEKg"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-all duration-300 ease-in-out bg-[#395C6B] hover:bg-white hover:shadow-md rounded-md p-2 hover:scale-110"
                aria-label="Join our Discord"
              >
                <svg
                  className="w-8 h-8 text-white hover:text-[#395C6B]"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div className="flex items-center space-x-4 mt-4 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="transition-all duration-300 ease-in-out bg-white hover:bg-gray-200 hover:shadow-md rounded-md p-2 hover:scale-110"
                aria-label="Join our Discord"
              >
                <svg
                  className="w-9 h-9 text-[#395C6B]"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
